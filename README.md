...
| Conversation | Push-to-talk on the laptop console (or the "Porcupine" wake word on a Pi mic) → Whisper → reply (laptop LLM over Wi-Fi, cloud GPT as fallback) → ElevenLabs; the robot stands still while talking |
